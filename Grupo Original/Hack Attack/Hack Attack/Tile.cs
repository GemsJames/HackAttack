...
{ 
     public class Tile
    {
        ...
        public enum Motion { Static, Horizontal, Vertical, Horizontal2, Vertical2 };
        ...
        public void Update(GameTime gameTime)
        {
            ...
            else if (motion == Motion.Horizontal2)
            {
            ...
            else if (motion == Motion.Vertical2)
            {
        ...
        public void UpdateCollision(ref Entity e)
        {
            ...
            {
                FloatRect preve = new Hack_Attack.FloatRect(e.PrevPosition.X, e.PrevPosition.Y, e.Animation.FrameWidth, e.Animation.FrameHeight);
